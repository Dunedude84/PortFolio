...
const translations = {
    fr: {
        ...
        'atm.alt': 'Projet Guichet Automatique',
        'atm.title': 'Guichet Automatique (Simulation ATM)',
        'atm.desc': "Simulation complète d'un guichet automatique développée en WPF selon l'architecture MVVM. Authentification client par NIP et portail administrateur, dépôts, retraits, virements, paiements de factures, intérêts, marge de crédit et prélèvements hypothécaires. Persistance Entity Framework Core sur SQL Server avec migrations et données de démonstration.",
        'atm.f1': 'Authentification client (NIP) et administrateur',
        'atm.f2': 'Dépôts, retraits, virements et paiements de factures',
        'atm.f3': 'Intérêts, marge de crédit et prélèvements hypothécaires',
        'atm.f4': 'Architecture MVVM, EF Core et SQL Server',
    ...
    en: {
        ...
        'atm.alt': 'ATM Simulation project',
        'atm.title': 'ATM Simulation (Desktop App)',
        'atm.desc': 'Complete automated teller machine simulation built with WPF following the MVVM pattern. Client PIN authentication and an admin portal, deposits, withdrawals, transfers, bill payments, interest, line of credit and mortgage pre-authorized debits. Entity Framework Core persistence on SQL Server with migrations and seed data.',
        'atm.f1': 'Client (PIN) and administrator authentication',
        'atm.f2': 'Deposits, withdrawals, transfers and bill payments',
        'atm.f3': 'Interest, line of credit and mortgage debits',
        'atm.f4': 'MVVM architecture, EF Core and SQL Server',
